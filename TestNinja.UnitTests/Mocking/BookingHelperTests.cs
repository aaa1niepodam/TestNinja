...
namespace TestNinja.UnitTests.Mocking
{
    ...
    public class BookingHelper_OverlappingBookingExistTests
    {
        ...
        [Test]
        public void BookingStartsBeforeAndFinishesInTheMiddleOfAnExistingBookingButFinishesAfter_ReturnExistingBookingsReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        public void BookingStartsAndFinishesAfterAnExistingBooking_ReturnEmptyString()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                ...
                DepartureDate = After(_existingBooking.DepartureDate.Date, days: 2),
            }, _repository.Object);
        ...
        private DateTime After(DateTime dateTime, int days = 1) => dateTime.AddDays(1);
